...
class Workbook {
  ...
  get model() {
    return {
      ...
      styles: this._styles ? this._styles.model : undefined,
    };
  }
  ...
  set model(value) {
    ...
    this._styles = value.styles ? new StylesXform() : new StylesXform.Mock(); // Add this line
    if (value.styles) {
      this._styles.model = value.styles;
    }
    this._worksheets = [];
