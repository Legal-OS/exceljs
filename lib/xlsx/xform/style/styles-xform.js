...
const CELL_STYLES_XFS_DEFAULT = {numFmtId: 0, fontId: 0, fillId: 0, borderId: 0, xfId: 0};
// =============================================================================
...
class StylesXform extends BaseXform {
  ...
  init() {
    ...
    this.model = {
      ...
      fills: [],
      dxfs: [],
      cellStyleXfs: [{...CELL_STYLES_XFS_DEFAULT}],
    };
  ...
  render(xmlStream, model) {
    ...
    if (this.index) {
      ...
      this.map.cellStyleXfs.render(xmlStream, model.cellStyleXfs || [{...CELL_STYLES_XFS_DEFAULT}]);
  ...
  parseClose(name) {
    ...
    switch (name) {
      case 'styleSheet': {
        ...
        if (!this.model.cellStyleXfs || this.model.cellStyleXfs.length === 0) {
          this.model.cellStyleXfs = [{...CELL_STYLES_XFS_DEFAULT}];
        }
...
class StylesXformMock extends StylesXform {
  constructor() {
    ...
    this.model = {
      styles: [{...CELL_STYLES_XFS_DEFAULT}],
      numFmts: [],
